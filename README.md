...
placeholder content — `Jules Eno`, a generic hero image, and so on.
...
> Replace every "Jules Eno" placeholder in this site with my name,
> "Jules Eno." Update the LinkedIn and GitHub links in index.html's social
> box to my profiles: <your LinkedIn URL> and <your GitHub URL>.

Things to personalize:

- [ ] Your name, replacing `Jules Eno` everywhere it appears.
